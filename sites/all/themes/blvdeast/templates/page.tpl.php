...
?>
 ...
 <?php if($_SERVER['SERVER_NAME']=='blvd.sjackson.dev2.drupalconnect.com' || $_SERVER['SERVER_NAME']=='blvdeastrentals.com' || $_SERVER['SERVER_NAME']=='portimperialblvdrentals.com') {
    				print theme('grid_block', preg_replace('/Homes/', 'Other Apts', $tabs), 'content-tabs');
    		}elseif($_SERVER['SERVER_NAME']=='imp.sjackson.dev2.drupalconnect.com' || $_SERVER['SERVER_NAME']=='blvdeastrentals.com' || $_SERVER['SERVER_NAME']=='portimperialblvdrentals.com') {
    				print theme('grid_block', preg_replace('/Homes/', 'Other Apts', $tabs), 'content-tabs');
    		}
		  ?>
