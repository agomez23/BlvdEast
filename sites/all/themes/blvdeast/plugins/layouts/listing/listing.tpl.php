<div class="panels-listing" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>
	<?php if($content['top']): ?>
		<div class="row">
	...
	<?php endif; ?>
	<?php if($content['listing_left'] || $content['right'] || $content['left2']): ?>
		<div class="row">
			<?php if($content['listing_left']): ?>
				<div class="block grid12-8 grid16-11 left listing_left">
					<div class="inner">
						<?php echo $content['listing_left']; ?>
					</div>
				</div>
			<?php endif ?>
			<?php if($content['left']): ?>
